# CLAUDE.md — DavisAI Master Context (Updated 2026-06-30 Session 47 — body canonical through S25; S47+S46+S45+S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `SESSION_HANDOFF_2026-06-30_S47.md` + `S47_SIZING_FINDINGS.md` + `KICKOFF_2026-07-01_S48.md`, not this whole file. BRANCH = `claude/crypto-liquidity-signals-s47-3l25k5` (keep `5c5vg9` synced).)
