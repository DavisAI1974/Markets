# CLAUDE.md — DavisAI Master Context (Updated 2026-07-12 Session 81 — Kalshi: lag made tradeable-or-not (direction easy 0.77 on big moves, edge is SIZE-vs-fee not direction; 1-min "full-minute lag" was coarse-bar aliasing — real reprice is SECONDS); Pyth sub-second feed BUILT+LIVE (`data/pyth-ticks`); `KALSHI_TRADING.md` file index. READ `SESSION_HANDOFF_2026-07-12_S81.md` first, then S80/S79, not this whole file)
