# CLAUDE.md — DavisAI Master Context (Updated 2026-07-03 Session 57 — body canonical through S25; S57+S56+S55+S54+S53+S52+S51+S50+S49+S48+S47+S46+S45+S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `SESSION_HANDOFF_2026-07-03_S57.md` + `KICKOFF_2026-07-04_S58.md`, not this whole file. BRANCH = designated `claude/*` (== canonical `5c5vg9`; keep synced). ⛔ BYBIT BANNED — see the block below.)
