# CLAUDE.md — DavisAI Master Context (Updated 2026-06-29 Session 44 — body canonical through S25; S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `SESSION_HANDOFF_2026-06-29_S44.md` + `SESSION_HANDOFF_2026-06-29_S43_ODBOOK.md`, not this whole file. BRANCH = `claude/crypto-liquidity-signals-5c5vg9` (== `-kb2i5c`, synced).)
