# CLAUDE.md — DavisAI Master Context (Updated 2026-07-01 Session 50 — body canonical through S25; S50+S49+S48+S47+S46+S45+S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `S50_CAPACITY_FINDINGS.md` + `SESSION_HANDOFF_2026-07-01_S50.md` + `KICKOFF_2026-07-02_S51.md` + `S49_SECOND_WINDOW_FINDINGS.md`, not this whole file. BRANCH = `claude/crypto-liquidity-signals-s49-rqtcfk` (== canonical `5c5vg9`; keep synced).)
