# CLAUDE.md — DavisAI Master Context (Updated 2026-07-03 Session 54 — body canonical through S25; S54+S53+S52+S51+S50+S49+S48+S47+S46+S45+S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `SESSION_HANDOFF_2026-07-03_S54.md` + `KICKOFF_2026-07-04_S55.md` + `S52_SIZING_MATRIX.md`, not this whole file. BRANCH = designated `claude/crypto-liquidity-signals-*` (== canonical `5c5vg9`; keep synced).)
