# CLAUDE.md — DavisAI Master Context (Updated 2026-06-30 Session 48 — body canonical through S25; S48+S47+S46+S45+S44+S43+S42+S41+S40+S39+S38+S37+S36b+S36+S35+S34+S33+S32 delta at top. READ `S48_TAKER_CUT_FINDINGS.md` + `SESSION_HANDOFF_2026-06-30_S47.md` + `S47_SIZING_FINDINGS.md` + `KICKOFF_2026-07-01_S48.md`, not this whole file. BRANCH = `claude/crypto-liquidity-signals-s48-2h9hx8` (ff'd up from the S47 tip; keep `5c5vg9` synced).)
