# CLAUDE.md — DavisAI Master Context (Updated 2026-07-12 Session 78 — MARKETS PIVOT crypto→Kalshi; body canonical through S25, crypto delta S37..S32 below. READ `SESSION_HANDOFF_2026-07-12_S78.md` + `KALSHI_BUILD_SCOPE.md` + `S77_REVIEW_FOR_CHATGPT.md`, not this whole file)
