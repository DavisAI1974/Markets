# Classroom continuation and original BOSS teacher role — 2026-09-22
...
The original teacher.py, c15_teacher.py and c15_teacher_r3.py were compared against the earlier remote survey; their Git blobs are unchanged:
- teacher.py: 8e2e902cfdce5069d8235e3697bae3f8adc940e2
- c15_teacher.py: 9c265dcd65104e4a91a935b1d7b00616ae6bdd23
- c15_teacher_r3.py: 19c438b8c014ddaa59e5f019bd2fef90f5dd8ba9

Scientific agreement does not automatically change governed mathematical targets or establish predictive/economic value. No second occurrence is required for a scoped mathematical/scientific conclusion when assumptions and evidence support it.

## Committed work

Source commit 0b5cc62a0b9e9b42921c3a44e3d68e917a5b1f4e extends the scientific role instructions, stages the full factual-correction evidence, resolves every correction in ordered pages, and verifies saved provider result content against the consumed answer.

Prior source commit 28045cef8e6746aefb27f088255f4391a097ed7a supplies:
- Complete principal classroom source delivery, including the shared research snapshot, all earlier learning, every current component, current notes and full digest.
- Exact source retrieval through a paged source index; retained exchanges resume from completed calls.
- Every observation cursor is accounted for across pages. Model claims remain unchanged for independent grading.
- Tests exercise all 19 components and 171 pairs through the real classroom grader, preserve earlier failures, and check retrieval/resumption and provider prompt mismatch.
- CI at that commit: box 59 tests plus 17 subtests passed; host job passed. Workflow 35811059074.

The full shared catalog is committed at research/kalshi/frankie_boss/knowledge/DIPOLE_SHARED_CATALOG_20260922.json:
127 sources, 3,519,892 bytes; all 71 historical baseline sources restored exactly plus 56 additional nonduplicate full sources.
Catalog SHA256: 9b2ca9849e4f119b2f814304b94d0c5162a6f597b76e9ce2ab25b9ab62facf01.
Snapshot: 7e0da7ebf7945ced5796621fc4b0bbc921f0914d91b3288120366058cfd27549.
Remote CI fetches and verifies every immutable source byte.
...
Remote GitHub/authorized remote runtime only. No local filesystem or shell, no C:/E: reads, no local skill reads/download/cache. Preserve exact market nanosecond integers; never parse persisted market JSON into JavaScript numbers. No ingestion restart, no canary, no native runner/Pod/EC2 stop, and no pinned Pod bootstrap changes. Keep all evidence using durable intent and receipted moves. Do not delete evidence, expose keys, truncate BOSS output, or silently omit research. Full-source staging is physical context management, not permission to drop sources.

Deployment after classroom completion is authorized. Do not dispatch the unchanged old Sunday workflow: it can restart ingestion and stop compute. Box session launch must honor an immutable commit rather than an old MARKETS_REF default.

Review agents exhausted their account usage allowance. Their completed source and tests were integrated; remaining review has been performed directly. No successful independent agent review of the entire final deployment is claimed.
