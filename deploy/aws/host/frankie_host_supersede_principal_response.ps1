...
$stateKind = 'response'
$intentSchema = 'FRANKIE_PRINCIPAL_RESPONSE_INTENT_V1'
$moveSchema = 'FRANKIE_PRINCIPAL_RESPONSE_MOVE_V1'
$completionSchema = 'FRANKIE_PRINCIPAL_RESPONSE_SUPERSEDED_V1'
$receiptPrefix = 'principal-response-superseded-'
$responseNames = @('session-response.json', 'host-session-record.json', 'classroom-correction-request.json', 'classroom-correction-response.json',
...
$kept = @('session-request.json', 'prompt.md', 'historical-prompt.md', 'receiver', 'bound-mapping.json', 'preparation-pins.json',
    'adapter-config.json', 'sealed-proof.json', 'memory-a-witness.json', 'run-findings-witness.json', 'calculation-pin-witness.json',
    'dipole-classroom-pre-message.json', 'dipole-classroom-model-visible.json', 'classroom-audit/dipole-classroom-source.json',
    'classroom-audit/dipole-classroom-teacher-key.audit.json')
