...
| `SESSION_HANDOFF_2026-07-13_S88.md` (+ S87, S86, S85, S84, S83, S82, S81, S80, S79, S78) | Session handoffs (S88 latest: the RAW-INGESTION correction — historical data raw/keep-all-info, gates only on the trade side; MBP-10 writer rewritten to keep everything; temp + forward-curve feeds; scoring scaffolding needs rework to raw). |
| `KICKOFF_2026-07-14_S89.md` (+ S88, S87, S86, S84, S83, S82, S81, S80, S79) | Session kickoffs (S89 next: build the DURABLE RAW-INGESTION WORKFLOW — reuse a coin durable-collector cron, point at Databento MBP-10, longer duration, gzip per month/day, re-pull May full-raw). |
