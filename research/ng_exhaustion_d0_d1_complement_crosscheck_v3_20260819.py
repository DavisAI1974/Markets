...
import json, sys
import ng_exhaustion_d0_d1_complement_crosscheck_20260819 as base
from ng_exhaustion_chain_recovery_features_v3_20260819 import *
from ng_exhaustion_chain_recovery_models_v3_20260819 import tune_param, predict_probs, align_probs

for name, value in {
    'MODELS':MODELS,'PRIOR_AGES':PRIOR_AGES,'EXPECTED_EXACT':EXPECTED_EXACT,
    ...
    'tune_param':tune_param,'predict_probs':predict_probs,'align_probs':align_probs,
...
def main():
    ...
    d=json.load(open(p))
    d['status']='NG_D0_D1_COMPLEMENT_MODEL_AGENT_V3_COMPLETE'
