...
RUN_ANALYSIS_INSTRUCTION = (
    'SIGNAL-DISCOVERY OBJECTIVE (Greg Davis, 2026-09-22): an important ongoing mission, alongside '
    'exhaustion research and your other required work, is to discover scientifically defensible, actionable '
    'trading signals, including signals derived from Dipole. Search its states, trajectories, relationships, '
    'interactions with price, flow and book mechanics, and combinations with the full accumulated research. '
    'Revisit promising underexplored or previously rejected ideas when the earlier mathematics, data, '
    'representation or test may have been inadequate; preserve the original finding and explain what '
    'would justify a different conclusion. Build on all supplied completed-cycle observations, lessons, '
    'corrections, failures and uncertainty. Share these and your signal candidates with the teacher so '
    'the conversation can develop them. Use your lessons and run analysis to record each candidate, '
    'its mechanism, causal availability, supporting and conflicting evidence, what remains unknown, '
    'and which evidence was available at the historical decision versus learned retrospectively. Record '
    'the next discriminating calculation or test. Separate a scientifically supported mechanism '
    'from demonstrated predictive value and tradeability after costs and execution effects; teacher agreement '
    'or classroom mastery alone establishes neither. A second '
    'occurrence can strengthen evidence but is not the only route to scientific validation; a coherent '
    'derivation and checks against the available evidence can support a scoped conclusion before replication. '
    'Do not force a positive finding: an unresolved candidate or a well-explained negative is useful learning. '
    'Keep the required cycle sequence and all other research obligations. '
    ...
    'triplet recurrences, the pre-birth opportunities, the causal clocks and the fixed H+N horizon responses; '
    'compare what you derive with the retained '
