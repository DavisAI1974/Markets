...
TRUNK_SCHEMA = "BOSS_FULL_HISTORY_TRUNK_V2"
__all__ = [
    "TrunkConfig",
    "FieldEncoder",
    "GatedDeltaCell",
...
class TrunkConfig:
    ...
    use_qsv flag is enabled by default. Explicit historical experiments may
    disable it; the full-history serving interface requires the branch.
    """
