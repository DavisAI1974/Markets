...
def _critic_context(state, intent):
    ...
    if (('native_snapshot_hash' in intent or route.encoding in ('compact_v1', 'stacked_v1', 'stacked_v2'))
    ...
    if route.encoding in ('stacked_v1', 'stacked_v2') and route.encode(native, knowledge=knowledge, **(config.get('context_encoding_options') or {})).text != snapshot.text:
