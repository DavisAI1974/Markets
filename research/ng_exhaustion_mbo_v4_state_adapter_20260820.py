...
class InstrumentBook:
    ...
    def __init__(self, instrument_id: int) -> None:
        ...
        self._legacy_group_visible_add = False
    ...
    def apply(
        ...
        if msg.action in ("A", "C", "M", "R"):
            ...
            self._legacy_group_visible_add |= msg.action == "A" and emit_legacy
        ...
        if final_book != self._legacy_group_book_before or self._legacy_group_visible_add:
            source = next(
